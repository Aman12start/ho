...
<?php echo $this->section('content');?>
               ...
               <div class="row">
                  <div class="col-12">
                     <div class="common-banner__inner">
                        <h2 class="title-animation">Disclaimer</h2>
         ...
         <section class="privacy">
            <div class="container">
               <div class="row">
                  <div class="col-12">
                     <div class="privacy-group" data-aos="fade-up" data-aos-duration="1200">
                        <h3 class="title-animation"> Disclaimer</h3>
                        <!-- <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quisquam, harum optio commodi
                           voluptatum perspiciatis cum repudiandae laborum aliquid similique magni reprehenderit
                           quam laudantium omnis ab quasi adipisci vel tempora tempore beatae doloribus ullam
                           voluptates? Officiis dolor odio ipsum eveniet iure!
                        </p>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit ducimus voluptates
                           beatae, reiciendis amet fugit est vitae optio qui, error doloribus molestiae a
                           temporibus natus et?
                        </p> -->
                        <p>Legal Disclaimer: Contents of Olbuiz homes website in terms of project details are subject to The Real Estate (Regulation and Development) Act 2016, rules framed there under and implementation thereof.
                           All specifications, designs, layout, images, conditions are only indicative and some of these can be changed at the discretion of the builder/architect/authority. 
                        </p>
                           <p>
                           These are purely conceptual and constitute no legal offerings. While every attempt has been made to ensure the accuracy of the plans shown, all measurement, positioning, fixtures, and fittings and any other data shown is an approximate interpretation for illustrative purpose only and are not to scale. No responsibility is taken for any error, omission, (MIS-STATEMENT) or use of data shown. The company reserves the right to make changes in the plans, specifications, dimensions and elevations without any prior notice. “Delivered means Delivered or partly delivered”.</p>
                     </div>
                     <!-- <div class="privacy-group" data-aos="fade-up" data-aos-duration="1200">
                        <h3 class="title-animation">Lorem ipsum dolor sit?</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit ducimus voluptates
                           beatae, reiciendis amet fugit est vitae optio qui, error doloribus molestiae a
                           temporibus natus et?
                        </p>
